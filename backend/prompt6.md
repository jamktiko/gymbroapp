...
Modify usersController.test.js, trainingProgramsController.test.js test files to reflect new changes in database model.

# Changes in database model

- **TrainingProgram** TrainingProgram now has a property called "exercises" instead of "moves". Previously it used to "moves". Furthermore, User has a trainingPrograms[] property which contains an array of TrainingPrograms.
